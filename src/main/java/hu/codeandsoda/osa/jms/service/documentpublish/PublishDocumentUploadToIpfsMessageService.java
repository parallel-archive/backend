...
@Service
public class PublishDocumentUploadToIpfsMessageService {

    private static Logger logger = LoggerFactory.getLogger(PublishDocumentUploadToIpfsMessageService.class);
