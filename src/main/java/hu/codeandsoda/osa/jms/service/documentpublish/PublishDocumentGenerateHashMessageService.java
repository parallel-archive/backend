...
@Service
public class PublishDocumentGenerateHashMessageService {

    private static Logger logger = LoggerFactory.getLogger(PublishDocumentGenerateHashMessageService.class);
