...
@Service
public class PublishDocumentDeleteOriginalDocumentMessageService {

    private static Logger logger = LoggerFactory.getLogger(PublishDocumentDeleteOriginalDocumentMessageService.class);
