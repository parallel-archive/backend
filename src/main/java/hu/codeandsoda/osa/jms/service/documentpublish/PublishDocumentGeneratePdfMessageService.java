...
@Service
public class PublishDocumentGeneratePdfMessageService {

    private static Logger logger = LoggerFactory.getLogger(PublishDocumentGeneratePdfMessageService.class);
